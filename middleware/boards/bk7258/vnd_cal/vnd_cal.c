...
char *vnd_cal_version         = "2025-06-12 11:18:27";
/**
...
const TXPWR_ST gtxpwr_tab_def_g[WLAN_2_4_G_CHANNEL_NUM] = {
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_INUSED),  // ch1  inused
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),  // ch4
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),  // ch7
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),  // ch10
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(48, TXPWR_ELEM_INUSED),  // ch13  inused
...
const TXPWR_ST gtxpwr_tab_def_n_40[WLAN_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),  // ch3
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
...
const TXPWR_ST gtxpwr_tab_def_ble[BLE_2_4_G_CHANNEL_NUM] = {
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),  // ch0 2402  inused
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),  // ch1 2404
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),  // ch4 2410
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(61, TXPWR_ELEM_UNUSED),  // ch9 2420
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),  // ch14 2430
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(60, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_INUSED),  // ch19 2440 inused
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),  // ch24 2450
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(59, TXPWR_ELEM_UNUSED),  // ch29 2460
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),  // ch34 2470
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(58, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(57, TXPWR_ELEM_UNUSED),  // ch39 2480 inused
};
